...
def minOverallAwkwardness(arr):
  ...
  res = min([max([abs(res[i] - res[i+1]) for i in range(n-1)] + [abs(res[0] - res[-1])]) for res in permutations(arr)])    
  return res
...
if __name__ == "__main__":
  ...
  #arr_3 = [1, 2, 5, 3, 7, 8, 10, 19, 50, 2, 3, 5, 7, 89, 56, 299, 34, 76, 1, 0, 500, 9, 150]
  #expected_3 = 201
